...
<body>
    ...
    <main class="d-flex d-flex flex-row text-bg-dark";>
        ...
        <div id="mainbody" class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark " style="width: 280px; height: 100vh;">
            ...
            <hr class="mt-4">
            <div class="dropdown">
      <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle " data-bs-toggle="dropdown" aria-expanded="true">
     
        <strong><?=$_SESSION['username'] ?></strong>
      </a>
      <ul class="dropdown-menu dropdown-menu-dark text-small shadow " style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(0px, -34px, 0px);" data-popper-placement="top-start">
      
        <li >

          <form action="system/logoutSystem.php" method="post">
                <input class="dropdown-item" type="submit" name="keluar" value="Keluar">
            </form>
        </li>
      </ul>
    </div>
 ...
 if(isset($_POST['login'])){
   //kode login
   //kalo login sukses
   echo "<script>Swal.fire({icon: 'success', title: 'Selamat datang!', showConfirmButton: false, timer: 3000});</script>";
 }
 ?>
    ...
    <script src="https://code.jquery.com/jquery-3.6.4.min.js" integrity="sha384-GLhlTQ8iNl+dnNlBq+Pi +KZYr4fGx4uHcO8F4Nv5P7Jh3n6UATD1qGKg4ZtZzQ" crossorigin="anonymous"></script>
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
    Swal.fire({
        ...
        text: 'Selamat datang di halaman dashboard <?=$_SESSION['username'] ?>',
    });
});
</script>
